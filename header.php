...
<body <?php body_class();?> style="background-image: url('<?php echo home_url('/');?>/wp-content/uploads/background_pattern-2.png');background-position: center top;background-size: auto;background-repeat: repeat;background-attachment: scroll;">
	...
	<?php endif; // true ==== $et_slide_header ?>
		...
		<header id="main-header" class="main-header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">

			<!-- Mobile Container -->
			<div class="mobile-container">
				<div clas="row">
					<div class="span12 group mobile-container--height">
						<?php
						...
						<div class="MY-SPINE mobile-phone">
							<a href="tel:727-697-7463"><i class="fas fa-phone"></i></a>
						</div>
					</div>
				</div>
				...
				<div class="row mobile-nav" style="display:none;">
			...
			<!-- Desktop Container -->
			<div class="container clearfix mobile-hide">
				<?php
					$logo = ( $user_logo = et_get_option( 'divi_logo' ) ) && '' != $user_logo
						? $user_logo
						: $template_directory_uri . '/images/logo.png';
